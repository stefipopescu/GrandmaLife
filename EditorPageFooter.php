			...
			<div class="col-md-3 w3agile_blog_left">
				...
				<div class="wthreesearch">
							...
							<form action="search.php" method="post">
								...
								<input type="search" name="search" value="search" placeholder="Search here" required="">

								<button type="submit" value="send" class="btn btn-default search" aria-label="Left Align">
	...
	<div class="copyright">
		...
		<div class="container">
			...
			<div class="agileinfo">
				...
				<p>Â© 2017 A GrandmaLife Production . All Rights Reserved . Design by <a href="http://w3layouts.com/">GrandmaLife</a></p>
